...
def QuickRegressors():
    ...
    try:
        ...
        st.sidebar.info("""
                            Ranking is a set of machine learning methods that tries to rank a list of items based on their relevance in a particular task. It is used to predict a real-value of a document. (E.g. ranking pages on a search engine based on their relevance to a given query).
                            """)
